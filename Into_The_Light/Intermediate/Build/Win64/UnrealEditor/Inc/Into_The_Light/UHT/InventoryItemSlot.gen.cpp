...
void Z_Construct_UClass_UInventoryItemSlot_Statics::NewProp_bIsMapB1_SetBit(void* Obj)
{
	((UInventoryItemSlot*)Obj)->bIsMapB1 = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UInventoryItemSlot_Statics::NewProp_bIsMapB1 = { "bIsMapB1", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UInventoryItemSlot), &Z_Construct_UClass_UInventoryItemSlot_Statics::NewProp_bIsMapB1_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsMapB1_MetaData), NewProp_bIsMapB1_MetaData) };
void Z_Construct_UClass_UInventoryItemSlot_Statics::NewProp_bIsMapF1_SetBit(void* Obj)
{
	((UInventoryItemSlot*)Obj)->bIsMapF1 = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UInventoryItemSlot_Statics::NewProp_bIsMapF1 = { "bIsMapF1", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UInventoryItemSlot), &Z_Construct_UClass_UInventoryItemSlot_Statics::NewProp_bIsMapF1_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsMapF1_MetaData), NewProp_bIsMapF1_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UInventoryItemSlot_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UInventoryItemSlot_Statics::NewProp_bIsMapB1,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UInventoryItemSlot_Statics::NewProp_bIsMapF1,
...
struct Z_CompiledInDeferFile_FID_Github_EkenLof_Games_ITL_2_0_Into_The_Light_Source_Into_The_Light_Public_UserInterface_Inventory_InventoryItemSlot_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInventoryItemSlot, UInventoryItemSlot::StaticClass, TEXT("UInventoryItemSlot"), &Z_Registration_Info_UClass_UInventoryItemSlot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInventoryItemSlot), 2800959320U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Github_EkenLof_Games_ITL_2_0_Into_The_Light_Source_Into_The_Light_Public_UserInterface_Inventory_InventoryItemSlot_h_2432739672(TEXT("/Script/Into_The_Light"),
